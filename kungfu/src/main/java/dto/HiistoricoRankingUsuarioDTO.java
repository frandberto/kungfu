...
public class HiistoricoRankingUsuarioDTO {
  ...
  private int qtdFaixaPreta;
	...
	public boolean equals(Object o) {
		if (o instanceof HiistoricoRankingUsuarioDTO) {
			HiistoricoRankingUsuarioDTO outroObjeto = (HiistoricoRankingUsuarioDTO) o;
