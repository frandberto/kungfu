...
import { KungfuHistoricoRankingComponent } from './kungfu-historicoRanking.component';
...
const appRoutes: Routes = [
  ...
  { path: 'rankingAnual', component: KungfuHistoricoRankingComponent },
...
@NgModule({
  ...
  declarations: [AppComponent, KungfuEdicaoEventosComponent, KungfuEditComponent, KungfuListComponent, 
      ...
      KungfuHistoricoRankingComponent, KungfuSobreComponent, LoginComponent, KungfuHomeComponent,
